...
public class LocalizacaoService {
	...
	public List<LocalizacaoDTO> getTodosOsDadosJSON(HttpServletResponse response) {
		logger.info("Tipo JSON suportado.");

		List<LocalizacaoDTO> dados = getTodosOsDadosJSON();
		return dados;
	}

	private List<LocalizacaoDTO> getTodosOsDadosJSON() {
